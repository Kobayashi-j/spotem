...
<head>
    ...
    <title>userid:<?= $_SESSION["userid"] ?></title>
        ...
        <div class="content">
            <div class="media">
                ...
                <div class="media-content">
                    <div class="element">
                        <!--投稿ユーザー名、ユーザーアイコン、投稿日、時間、テキスト、画像、位置情報、いいね数取得-->
                        <strong class="username">Cafe・○○</strong> <small class="date">31m</small>
                        <br>
